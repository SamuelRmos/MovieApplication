...
interface MovieApi {
    ...
    @GET("movie/popular")
    suspend fun getPopularMovieAsync(): Response<MovieResponse>

    @GET("movie/top_rated")
    suspend fun getRatedMovieAsync(): Response<MovieResponse>

    @GET("trending/movie/day")
    suspend fun getTodayMovieAsync(): Response<MovieResponse>
