...
@Composable
fun TodayMovieListRow(
    modifier: Modifier = Modifier,
    viewModel: TodayMoviesViewModel,
...
fun TodayMovieList(
    ...
    val requestState by viewModel.stateTodayMovie.collectAsState()
    val paginationState by viewModel.paginationTodayState.collectAsState()
